...
Orbsona is prepared for publication as the public package `@accidental-revenue/orbsona` under the existing [`accidental-revenue`](https://www.npmjs.com/org/accidental-revenue) npm organization.
...
The intended initial public Orbsona release is `0.1.0`.
