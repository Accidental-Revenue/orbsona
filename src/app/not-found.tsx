...
export default function NotFound() {
  return (
    <section className="flex h-full items-center px-6 py-12" aria-labelledby="not-found-title">
      <div className="mx-auto max-w-xl text-center">
        <h1 id="not-found-title" className="text-4xl font-semibold tracking-[-0.04em] text-neutral-100">This identity does not exist.</h1>
