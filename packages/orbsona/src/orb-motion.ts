...
export function updateMotion(
  ...
  // ElevenLabs' reference orb treats microphone and agent output as separate
  // signals. The optional levels allow the exported component to do the same;
  // the studio uses a natural preview envelope when no live tracks are present.
